...
import dagshub
dagshub.init(repo_owner='smithpriyanshu12', repo_name='Network_Security', mlflow=True)
...
class ModelTrainer:
    ...
    def train_model(self,X_train,y_train,x_test,y_test):
        ...
        # logging.info(f"Network Model saved at {self.model_trainer_config.trained_model_file_path}")
        #model pusher
        ...
        logging.info(f"Classification_train_metric: {classification_train_metric}")
        logging.info(f"Classification_test_metric: {classification_test_metric}")
